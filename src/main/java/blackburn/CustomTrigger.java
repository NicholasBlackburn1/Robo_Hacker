...
public class CustomTrigger implements ICriterionTrigger<CustomTrigger.Instance>
{
     ...
     */
    public void trigger(PlayerEntity entityPlayer)
    {
        CustomTrigger.Listeners tameanimaltrigger$listeners = listeners.get(
                ((ServerPlayerEntity) entityPlayer).getAdvancements());

        if (tameanimaltrigger$listeners != null)
        {
            tameanimaltrigger$listeners.trigger((ServerPlayerEntity) entityPlayer);
        }
    }
