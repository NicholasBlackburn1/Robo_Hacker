...
public class VillagerEntity extends AbstractVillagerEntity implements IReputationTracking, IVillagerDataHolder {
   ...
   public static final Map<MemoryModuleType<GlobalPos>, BiPredicate<VillagerEntity, PointOfInterestType>> JOB_SITE_PREDICATE_MAP = ImmutableMap.of(MemoryModuleType.HOME, (p_213769_0_, p_213769_1_) -> {
      ...
      if (this.world instanceof ServerWorld) {
         ...
         if (optional.isPresent()) {
            ...
            optional.get().stream().filter((p_223349_0_) -> {
               ...
               serverworld.updateReputation(IReputationType.VILLAGER_KILLED, murderer, (IReputationTracking)p_223342_2_);
            });
         }
      }
   }
   ...
   public void resetMemoryPoint(MemoryModuleType<GlobalPos> moduleType) {
      if (this.world instanceof ServerWorld) {
         ...
         this.brain.getMemory(moduleType).ifPresent((p_213752_3_) -> {
