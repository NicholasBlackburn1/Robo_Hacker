...
public class StockModelShapes {
   ...
   public static final ModelsUtil[] STEM_GROWTH_STAGES = IntStream.range(0, 8).mapToObj((p_240335_0_) -> {
      return makeBlockModel("stem_growth" + p_240335_0_, "_stage" + p_240335_0_, StockTextureAliases.STEM);
   }).toArray((p_240331_0_) -> {
