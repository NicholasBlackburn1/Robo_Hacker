...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      this.registerLootTable(Blocks.LARGE_FERN, (p_218572_0_) -> {
         return droppingSeedsTall(p_218572_0_, Blocks.FERN);
      });
      this.registerLootTable(Blocks.TALL_GRASS, (p_241752_0_) -> {
         return droppingSeedsTall(p_241752_0_, Blocks.GRASS);
      });
      ...
      this.registerLootTable(Blocks.ATTACHED_MELON_STEM, (p_218531_0_) -> {
         return dropSeedsForStem(p_218531_0_, Items.MELON_SEEDS);
      });
      ...
      this.registerLootTable(Blocks.ATTACHED_PUMPKIN_STEM, (p_218509_0_) -> {
         return dropSeedsForStem(p_218509_0_, Items.PUMPKIN_SEEDS);
      });
   ...
   public void registerFlowerPot(Block flowerPot) {
      this.registerLootTable(flowerPot, (p_241751_0_) -> {
         return droppingAndFlowerPot(((FlowerPotBlock)p_241751_0_).getFlower());
      });
   }
