...
public class ServerWorldInfo implements IServerWorldInfo, IServerConfiguration {
   ...
   private void serialize(DynamicRegistries registry, CompoundNBT nbt, @Nullable CompoundNBT playerNBT) {
      ...
      DimensionGeneratorSettings.field_236201_a_.encodeStart(worldgensettingsexport, this.generatorSettings).resultOrPartial(Util.func_240982_a_("WorldGenSettings: ", LOGGER::error)).ifPresent((p_237373_1_) -> {
         nbt.put("WorldGenSettings", p_237373_1_);
      });
      ...
      DatapackCodec.CODEC.encodeStart(NBTDynamicOps.INSTANCE, this.worldSettings.getDatapackCodec()).result().ifPresent((p_237371_1_) -> {
         nbt.put("DataPacks", p_237371_1_);
      });
