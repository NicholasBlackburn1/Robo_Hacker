...
public class NetherBiomeProvider extends BiomeProvider {
   ...
   public static final MapCodec<NetherBiomeProvider> PACKET_CODEC = RecordCodecBuilder.mapCodec((p_242602_0_) -> {
      return p_242602_0_.group(Codec.LONG.fieldOf("seed").forGetter((p_235286_0_) -> {
         ...
         return p_235284_0_.biomeAttributes;
   ...
   public static final Codec<NetherBiomeProvider> CODEC = Codec.mapEither(NetherBiomeProvider.DefaultBuilder.CODEC, PACKET_CODEC).xmap((p_235277_0_) -> {
      return p_235277_0_.map(NetherBiomeProvider.DefaultBuilder::build, Function.identity());
   }, (p_235275_0_) -> {
      return p_235275_0_.getDefaultBuilder().map(Either::<NetherBiomeProvider.DefaultBuilder, NetherBiomeProvider>left).orElseGet(() -> {
   ...
   private Optional<NetherBiomeProvider.DefaultBuilder> getDefaultBuilder() {
      return this.netherProviderPreset.map((p_242601_1_) -> {
   ...
   public Biome getNoiseBiome(int x, int y, int z) {
      ...
      return this.biomeAttributes.stream().min(Comparator.comparing((p_235272_1_) -> {
   ...
   static class Noise {
      ...
      public static final Codec<NetherBiomeProvider.Noise> CODEC = RecordCodecBuilder.create((p_242613_0_) -> {
         return p_242613_0_.group(Codec.INT.fieldOf("firstOctave").forGetter(NetherBiomeProvider.Noise::getNumberOfOctaves), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(NetherBiomeProvider.Noise::getAmplitudes)).apply(p_242613_0_, NetherBiomeProvider.Noise::new);
      });
   ...
   public static class Preset {
      ...
      public static final NetherBiomeProvider.Preset DEFAULT_NETHER_PROVIDER_PRESET = new NetherBiomeProvider.Preset(new ResourceLocation("nether"), (p_242617_0_, p_242617_1_, p_242617_2_) -> {
