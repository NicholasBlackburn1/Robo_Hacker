...
public final class Dimension {
   public static final Codec<Dimension> CODEC = RecordCodecBuilder.create((p_236061_0_) -> {
      return p_236061_0_.group(DimensionType.DIMENSION_TYPE_CODEC.fieldOf("type").forGetter(Dimension::getDimensionTypeSupplier), ChunkGenerator.field_235948_a_.fieldOf("generator").forGetter(Dimension::getChunkGenerator)).apply(p_236061_0_, p_236061_0_.stable(Dimension::new));
   });
