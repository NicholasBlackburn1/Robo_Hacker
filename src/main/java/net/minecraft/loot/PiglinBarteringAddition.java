...
public class PiglinBarteringAddition implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      p_accept_1_.accept(LootTables.PIGLIN_BARTERING, LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(Items.BOOK).weight(5).acceptFunction((new EnchantRandomly.Builder()).func_237424_a_(Enchantments.SOUL_SPEED))).addEntry(ItemLootEntry.builder(Items.IRON_BOOTS).weight(8).acceptFunction((new EnchantRandomly.Builder()).func_237424_a_(Enchantments.SOUL_SPEED))).addEntry(ItemLootEntry.builder(Items.POTION).weight(8).acceptFunction(SetNBT.builder(Util.make(new CompoundNBT(), (p_239833_0_) -> {
