...
public class SoundEngine {
                           ...
                           if (!flag3) {
                              this.audioStreamManager.createResource(sound.getSoundAsOggLocation()).thenAccept((p_217934_1_) -> {
                                 channelmanager$entry.runOnSoundExecutor((p_217925_1_) -> {
                                    p_217925_1_.bindBuffer(p_217934_1_);
                                    p_217925_1_.play();
                                 });
                              });
                           } else {
                              this.audioStreamManager.createStreamingResource(sound.getSoundAsOggLocation(), flag2).thenAccept((p_217928_1_) -> {
                                 channelmanager$entry.runOnSoundExecutor((p_217935_1_) -> {
                                    p_217935_1_.playStreamableSounds(p_217928_1_);
                                    p_217935_1_.play();
                                 });
                              });
                           }
   ...
   public void pause() {
      if (this.loaded) {
         this.channelManager.runForAllSoundSources((p_217929_0_) -> {
   ...
   public void resume() {
      if (this.loaded) {
         this.channelManager.runForAllSoundSources((p_217936_0_) -> {
