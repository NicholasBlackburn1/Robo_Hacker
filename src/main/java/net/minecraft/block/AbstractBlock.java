...
public abstract class AbstractBlock {
   ...
   public static class Properties {
      ...
      private AbstractBlock.IExtendedPositionPredicate<EntityType<?>> allowsSpawn = (p_235832_0_, p_235832_1_, p_235832_2_, p_235832_3_) -> {
      ...
      private AbstractBlock.IPositionPredicate isOpaque = (p_235853_0_, p_235853_1_, p_235853_2_) -> {
         return p_235853_0_.getMaterial().isOpaque() && p_235853_0_.hasOpaqueCollisionShape(p_235853_1_, p_235853_2_);
      };
      private AbstractBlock.IPositionPredicate suffocates = (p_235848_1_, p_235848_2_, p_235848_3_) -> {
         return this.material.blocksMovement() && p_235848_1_.hasOpaqueCollisionShape(p_235848_2_, p_235848_3_);
      };
